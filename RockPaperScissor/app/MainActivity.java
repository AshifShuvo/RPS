...
public class MainActivity extends AppCompatActivity {
    Button b_rock, b_paper, b_scissors, b_singlePlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_singlePlayer = (Button) findViewById(R.id.b_spm);
    ...
    protected void singlePlayerMode(){
        ...
        tv_computer_choice = (TextView) findViewById(R.id.tv_c_choice);
